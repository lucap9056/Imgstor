...
const SideOptions: React.FC = () => {
  ...
  const defaultSort =
    (cookies.get("sort") as Sort) || ImgstorImage.SORT.DEFAULT;
  ...
  const handleVisibleSearch = () => {
    ...
    setSidePage(
      <Search onchange={setSearchContent} hide={handleHideSidePage}></Search>,
    );
  };
  ...
  return (
    <div className={styles.container}>
      <div
        className={styles.side_page}
        data-visibled={sidePageName !== undefined}
      >
        {sidePage}
      </div>
