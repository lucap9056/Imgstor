...
const SettingHostingServices: React.FC = () => {
      ...
      const updatedHostingServicesConfig: HostingServicesConfig = {
        ...
        catbox: {
          ...
          separatePreviewUpload:
            form.get(NAMES.CATBOX_SEPARATE_PREVIEW) === "true",
        },
        smms: {
          ...
          separatePreviewUpload:
            form.get(NAMES.SMMS_SEPARATE_PREVIEW) === "true",
        },
      };
  ...
  return (
    <div className={styles.settings_page}>
      <form
        className={styles.settings_page_main}
        onReset={handleBack}
        onSubmit={handleSave}
      >
        <Block
          title={t("settings.hosting-service.title.local")}
          visible={false}
        >
        ...
        <Block
          title={t("settings.hosting-service.title.import")}
          visible={false}
        >
        ...
        <div className={styles.settings_page_options}>
          ...
          <button className={styles.settings_page_option} type="submit">
            {t("main.save")}
          </button>
        </div>
      </form>
