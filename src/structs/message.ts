...
export type MessageButtonEvent<T extends keyof MessageButtonEventDefinitions> =
  MessageButtonEventDefinitions[T];
...
export class Message {
  ...
  private static get CreateId(): string {
    ...
    return Array.from(buf)
      .map((num) => (num < 0x10000 ? "0" : "") + num.toString(16))
      .join("-");
  }
...
export type MessageManagerEvent<
  T extends keyof MessageManagerEventDefinitions,
> = MessageManagerEventDefinitions[T];
