import type { FileFormat, FormatNames } from "services/converter/file-formats";

const SUPPORTED_FORMATS: FormatNames[] = ["JPEG", "PNG", "WebP"];
...
function IsSupported(
  ...
  return (
    SUPPORTED_FORMATS.includes(source_format.name) &&
    SUPPORTED_FORMATS.includes(target_format.name)
  );
}
