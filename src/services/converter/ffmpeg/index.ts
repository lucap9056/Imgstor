...
async function PreprocessAnimation(
  abortController: AbortController,
  file: File,
...
async function ConvertAnimation<T extends boolean>(
  abortController: AbortController,
  file: File,
  targetForamt: FileFormat,
  extractFirstFrame: T,
  LogMessage: LogPrinter,
): Promise<{
  converted: {
...
async function ExtractFirstFrameFromAnimation(
  abortController: AbortController,
  file: File,
  LogMessage: LogPrinter,
): Promise<{
